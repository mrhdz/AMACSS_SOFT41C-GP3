    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="navbar-menu" id="navbar-menu">
                <a href="gestioncanchas.php"><i class="bi bi-calendar2-week"></i> Gestión de Canchas</a>
                <a href="gestionreservas.php"><i class="bi bi-bookmark-check"></i> Gestión de Reservas</a>
                <a href="historialreservas.php"><i class="bi bi-clock-history"></i> Historial</a>
                <a href="panel_control.php"><i class="bi bi-speedometer2"></i> Panel de Control</a>
